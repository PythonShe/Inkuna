...
| Rendering | Core engine display lists drawn natively | `PageView` draws per-page glyph runs via Core Text (`CTFontDrawGlyphs`) |
...
- User-visible strings are localized into 16 languages via the
