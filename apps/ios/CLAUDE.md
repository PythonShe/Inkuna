...
| Rendering | Core engine display lists drawn natively | `PageView` draws per-page glyph runs via Core Text (`CTFontDrawGlyphs`); the former renderer was removed by the 2026-08-21 ADR amendment |
