...
const en = {
  ...
  "beta.h": "Try the beta",
  "beta.pre": "The beta is open — join it on ",
  "beta.post": ".",
  "betaAndroid.pre": "Download the ",
  "betaAndroid.link": "latest test APK",
  "betaAndroid.post": ".",
  "betaInternal.pre":
    "Want every new build the moment it ships? Send the email address of your Apple ID to ",
  "betaInternal.post": " for an invitation to the internal tester group.",
  "platforms.pre":
...
const ja: typeof en = {
  ...
  "betaInternal.pre":
    "新しいビルドをいち早く受け取りたい方は、Apple ID のメールアドレスを ",
  "betaInternal.post":
    " までお送りください。内部テスターグループにご招待します。",
...
const zh: typeof en = {
  ...
  "betaAndroid.post": "。",
  "betaInternal.pre": "想第一时间收到每个新构建？把你的 Apple ID 邮箱发送至 ",
  "betaInternal.post": "，即可获得内部测试组的邀请。",
